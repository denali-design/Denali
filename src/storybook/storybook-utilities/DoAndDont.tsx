...
const DoAndDont: React.FC<DoAndDontProps> = ({
  ...
  return (
    <div className={`pb-6 pt-3 ${containerClasses}`}>
      {/* Do Section */}
      <div className="overflow-hidden rounded border-t-4 p-4 canvas-success stroke-success-vivid">
        <div className="grid grid-cols-12 gap-2">
          <div className="col-start-1 col-end-1">
            <div className="flex h-6 w-6 items-center justify-center rounded-full canvas-success-vivid">
              <Icon
                color="on-vivid"
      ...
      {/* Don't Section */}
      <div className="overflow-hidden rounded border-t-4 p-4 canvas-danger stroke-danger-vivid">
        <div className="grid grid-cols-12 gap-2">
          <div className="col-start-1 col-end-1">
            <div className="flex h-6 w-6 items-center justify-center rounded-full canvas-danger-vivid">
              <Icon
                color="on-vivid"
                name="icon-control-check"
                size="sm"
