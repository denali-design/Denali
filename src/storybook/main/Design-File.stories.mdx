...
<Unstyled>
    ...
    <Heading type="article" level="1">Figma Denali Design System Libaray</Heading>
    ...
    <Heading type="article" level="2">How to Download</Heading>
    ...
    <Heading type="article" level="2">Figma Design System</Heading>
    <Button label="Download"/>

    <Heading type="article" level="2">Frequently Asked Questions</Heading>
    ...
    <Heading type="article" level="2">Support</Heading>
